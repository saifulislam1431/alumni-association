...
const JobDetails = () => {
    ...
    return (
        <section className='w-full px-6'>
            <DashHead title={`Job Details Of ${post?.position}`} />

            <div className="my-8 w-full">
                <div className="flex justify-between items-center mb-6">
                    <a href="/career" className="text-blue-500 hover:underline text-sm">
                ...
                <div className="grid grid-cols-1 gap-8 mb-6 w-full">
                    <div>
                        ...
                        <p>Company Firm: {post?.company_name}</p>
                    ...
                    <div className='py-10 lg:w-1/2'>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-4 w-full'>
                            ...
                            <input type='email' defaultValue={userInfo?.email ? userInfo?.email : ""} placeholder='Enter Your Email'
                                ...
                                className='inputField' disabled={true} />
