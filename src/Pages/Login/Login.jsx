...
import img from "../../assets/banner/signIn.png"
    ...
    return (
        <section className='flex flex-col space-y-10 lg:space-y-0 lg:flex-row w-4/5 mx-auto rounded-xl my-14 border-2'>
            ...
            <div className='p-8 w-full lg:w-1/2 border-r-2 bg-white'>
                ...
                <p className='mt-7 text-center font-semibold'> Don&apos;t Have An Account ? </p>
            ...
            <div className='w-full lg:w-1/2 p-8 bg-white'>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-4 w-[90%] mx-auto mt-10'>
                    ...
                    <button input type="submit" className="btn btn-block px-5 py-2.5 relative rounded group overflow-hidden font-medium bg-gray-700  text-white inline-block">
                        <span className="absolute bottom-0 left-0 flex w-full h-0 mt-0 transition-all duration-500 ease-out transform translate-y-0 bg-primary hover:text-white  group-hover:h-full ">
                        </span><span className="relative group-hover:text-gray-800 flex items-center gap-4 justify-center hover:text-white">
                            Sign In  </span></button>
                </form>

                <div className="divider my-9 font-medium">Or Continue With </div>
